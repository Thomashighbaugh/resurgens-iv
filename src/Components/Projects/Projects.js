        ...
        <List>
          <Grid container justify="center">
            <Project
              ...
              cardImage="%PUBLIC_URL%/src/Components/Projects/Project-Images/Resurgens3.png"
            ...
            <Project
              ...
              cardImage="%PUBLIC_URL%/src/Components/Projects/Project-Images/Splash-Page.png"
              githubLink="https://github.com/"
              hostedLink=""
              isHosted={false}
            />
            ...
            <Project
              ...
              cardImage="%PUBLIC_URL%/src/Components/Projects/Project-Images/EvoPopDark.png"
              githubLink="https://github.com/"
            ...
            <Project
              ...
              cardImage="%PUBLIC_URL%/src/Components/Projects/Project-Images/Colt45GUI.png"
              githubLink="https://github.com/"
              hostedLink="https://www.youtube.com/watch?v=Q_7KaMDHoGs"
              isHosted={true}
            />
            <Project
              ...
              cardImage="%PUBLIC_URL%/src/Components/Projects/Project-Images/Decom.png"
              githubLink="https://github.com/"
              hostedLink="https://www.youtube.com/watch?v=Q_7KaMDHoGs"
              isHosted={true}
            />
            <Project
              ...
              cardImage="%PUBLIC_URL%/src/Components/Projects/Project-Images/BlogTemplate.png"
              githubLink="https://github.com/"
              hostedLink="https://www.youtube.com/watch?v=Q_7KaMDHoGs"
              isHosted={true}
            />
